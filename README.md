...
## Wireframes
The wireframes for Creative Dreams were created in the software [Balsamiq](https://balsamiq.com). The wireframes have been created for desktop, tablet and mobile devices. Relevant text content had not been written when the wireframes were produced. The final site has some smaller visual differences compared to the wireframes due to design choices that was being made during the process of creation.
...
* ### Portfolio Section
 ...
 ![Portfolio](readme/assets/images/portfolio.png)
...
* ### Contact Section
 ...
 ![Contact Us](readme/assets/images/contact_us.png)
...
![Form Confirmation](readme/assets/images/form_confirmation.png)
...
## Code Validation
The Creative Dreams has been tested through both [W3C html Validator](https://validator.w3.org/) and the [W3C CSS Validator](https://jigsaw.w3.org/css-validator/). Minor errors were found on the Form Confirmation Page but could easily be fixed (see [bugs section](#known-bugs)).
...
**2022-07-20**
* Bug: During the HTML-validation two minor errors were reported from the validator. The errors were generated by two faulty div elements in form_confirmation.html.
...
### Unfixed Bugs
**2022-07-20**
* Bug: When clicking the menu items on the form confirmation page the Javascript highlight function doesn't work (the highlight doesn't remain when coming back to index.html), it only works within the homepage (index.html). No big issue why I choose to leave it as it is in this project.

**2022-07-22**
* Bug: When clicking menu items they get highlighted when you click within the specifik link area and not only when you click directly on the link. Minor issue why I choose to leave it as it is in this project.
